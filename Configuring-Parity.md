...
Legacy Options:
  ...
  --dapps-user USERNAME            Dapps server authentication has been removed. (default: None)
  --dapps-pass PASSWORD            Dapps server authentication has been removed. (default: None)
  --dapps-apis-all                 Dapps server is merged with RPC server. Use --jsonrpc-apis. (default: None)
  --dapps-cors URL                 Dapps server is merged with RPC server. Use --jsonrpc-cors. (default: None)
  --dapps-hosts HOSTS              Dapps server is merged with RPC server. Use --jsonrpc-hosts. (default: None)
  --dapps-interface IP             Dapps server is merged with RPC server. Use --jsonrpc-interface. (default: None)
  --dapps-port PORT                Dapps server is merged with RPC server. Use --jsonrpc-port. (default: None)
